        ...
        <div class="card-body">
            ...
            <div class="form-row">
                <div class="form-group col">
                    <label for="selling_quantity_cts">Selling Quantity (Cts.)</label>
                    <input type="text" class="form-control" id="selling_quantity_cts" placeholder="Enter Selling Quantity in Carats">
                </div>
                <div class="form-group col">
                    <label for="selling_quantity_pcs">Selling Quantity (Pcs.)</label>
                    <input type="text" class="form-control" id="selling_quantity_pcs" placeholder="Enter Selling Quantity in Pieces">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col">
                    <label for="selling_price_request">Seller Price Req. ($/ct.)</label>
                    <input type="text" class="form-control" id="selling_price_request" placeholder="Enter Buying Pricing Request">
                </div>
                <div class="form-group col">
                    <label for="selling_offer_ppc">Seller's offer PPC</label>
                    <input type="text" class="form-control" id="selling_offer_ppc" placeholder="Enter Buying Offer">
                </div>
            </div>
            <div class="form-group">
                <label for="selling_comments">Selling Comments</label>
                <textarea class="form-control" id="selling_comments" placeholder="Enter Selling Comments"></textarea>
            </div>
            <div class="form-group d-flex justify-content-end">
                <a class="btn btn-primary next-tab" href="#">Add Selling Request</a>
            </div>
        </div>
    </div>
</div>