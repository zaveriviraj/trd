    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="color_comments" placeholder="Enter Color Comments"></textarea>
            </div>
            <div class="form-group">
                <label>Clarity</label>
                <br>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="branches_comments" placeholder="Enter Branches Comments"></textarea>
            </div>
            <div class="form-group">
                <label for="product_comments">Product Comments</label>
                <textarea class="form-control" id="product_comments" placeholder="Enter Product Comments"></textarea>
            </div>
